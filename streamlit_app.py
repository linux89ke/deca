...
st.markdown("---")
st.caption("Decathlon Product Lookup · Powered by your Decathlon working file") if size is not available in sizes.txt for fashion items then return file with missing sizes marked shaded red
